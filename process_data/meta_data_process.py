...
META_ROOT = '/home/jacky/Rachel/COMP5331/Pre-training/meta' # Set your meta data path
SEQ_ROOT = '/home/jacky/Rachel/COMP5331/Pre-training/seq' # Set your seq data path

pretrain_categories = ['Movies_and_TV']
...
def extract_meta_data(path, meta_data, selected_asins):
    ...
    with gzip.open(path) as f:
        for line in tqdm(f, ncols=100):
            ...
            category = ' '.join(line['category'] if 'category' in line else [])

            brand = line['brand'] if 'brand' in line else ""
